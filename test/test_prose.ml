...
let test_classes () =
  ...
  Alcotest.(check string) "prose-slate class" "prose-slate" (to_string prose_slate)
...
let test_combinations () =
  ...
  Alcotest.(check string) "complex prose" "prose prose-xl prose-gray mx-auto" complex
...
let test_inline_styles () =
  ...
  Alcotest.(check bool) "has max-width" true
  ...
  Alcotest.(check bool) "prose-lg has font-size" true
