...
module Handler = struct
  ...
  let col_auto ?theme () =
    match Theme.override theme "grid-column-auto" with
    | Some _ ->
  ...
  let col_start_auto ?theme () =
    match Theme.override theme "grid-column-start-auto" with
  ...
  let col_end_auto ?theme () =
    match Theme.override theme "grid-column-end-auto" with
  ...
  let row_auto ?theme () =
    match Theme.override theme "grid-row-auto" with
    | Some _ ->
  ...
  let row_start_auto ?theme () =
    match Theme.override theme "grid-row-start-auto" with
  ...
  let row_end_auto ?theme () =
    match Theme.override theme "grid-row-end-auto" with
  ...
  let of_class theme class_name =
    ...
    | [ "col"; "start"; n ] -> (
        ...
        | Error _ ->
            if
              ...
              && Theme.override (Some theme) ("grid-column-start-" ^ n) <> None
    ...
    | [ "col"; "end"; n ] -> (
        ...
        | Error _ ->
            if
              (not (String.contains n '/'))
              && Theme.override (Some theme) ("grid-column-end-" ^ n) <> None
    ...
    | [ "row"; "start"; n ] -> (
        ...
        | Error _ ->
            if
              (not (String.contains n '/'))
              && Theme.override (Some theme) ("grid-row-start-" ^ n) <> None
    ...
    | [ "row"; "end"; n ] -> (
        ...
        | Error _ ->
            if
              (not (String.contains n '/'))
              && Theme.override (Some theme) ("grid-row-end-" ^ n) <> None
